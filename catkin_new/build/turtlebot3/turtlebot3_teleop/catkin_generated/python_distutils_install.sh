...
echo_and_run cd "/home/pubudu/catkin_new/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pubudu/catkin_new/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/pubudu/catkin_new/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
